...
\newcommand{\thesistitle}{Moduli Spaces associated to Legendrian Links in the Cocircle Bundle of a Cylinder from Positive Braid Closures} % Thesis title
\newcommand{\thesistitlecaps}{Moduli Spaces associated to Legendrian Links in the Cocircle Bundle of a Cylinder from Positive Braid Closures} % Capitalized thesis title
