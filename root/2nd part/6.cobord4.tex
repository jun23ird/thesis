...
=
\begin{tikzcd}
\C\xrightarrow{\times a}\C \arrow[r, "{(\times 0,\times 1)}"]\arrow[d, "{(\times 1,\iota_1)}"] & \C \arrow[d, "\iota_1"] \\
\C^{m+1} \arrow[r, "{(0,id)}"] & \C^{2}
\end{tikzcd}
...
=
\begin{tikzcd}
\C[-1] \arrow[r,"{(\times 1,\times 0)}"] \arrow[d, "{(\times 1, \times 0)}"] & \C\xrightarrow{\times a}\C \arrow[d,"{(\times 1, \iota_1)}"] \\
\C\xrightarrow{\times b} \C \arrow[r, "{(\times 1,\iota_0)}"] & \C^2 \xrightarrow{(b~a)}\C
\end{tikzcd}
...
=
\begin{tikzcd}
\C[-1] \arrow[r, "{(\times 1,\times 0)}"]\arrow[d, ] & \C\xrightarrow{\times a}\C \arrow[d, "{(\times 0, \times 1)}"] \\
0 \arrow[r,] & \C
\end{tikzcd}
...
=
\begin{tikzcd}
\C\xrightarrow{\times b}\C \arrow[r, "{(\times 1,\iota_0)}"]\arrow[d, "{(\times 0, \times 1)}"] & \C^{2}\xrightarrow{(b~a)}\C \arrow[d, "{(\times 0, id)}"] \\
\C \arrow[r, "\iota_0"] & \C^{2}
\end{tikzcd}
...
\C[-1] \arrow[dd,"{(\times 1,\times 0)}"']\arrow[rr,"{(\times 1,\times 0)}"] \arrow[ur,"0"] & & \C\xrightarrow{\times a}\C \arrow[dd,"{(\times 1, \iota_1)}"]\arrow[ur,"{(\times 0, \times 1)}"']& \\
& \C \arrow[rr,"\iota_0"] & & \C^{2}  \\
\C\xrightarrow{\times b}\C \arrow[rr,"{(\times 1,\iota_0)}"] \arrow[ur,"{(\times 0,\times 1)}"] & & \C^{2}\xrightarrow{(b~a)}\C \arrow[ur,"{(\times 0, id)}"] &
\end{tikzcd}
\\ whose total complex is 
\[
\operatorname{Tot}(
\begin{tikzcd}
\C\xrightarrow{\times b}\C \arrow[r,"{(\times 1,M_1)}"]& \C^3\xrightarrow{(0~b~a)}\C \arrow[r,"{(\times 0,M_2)}"] &\C^2\\
0\rightarrow\C \arrow[u, "{(\times 1, \times 0)}"]\arrow[r,"{(\times 1, \times 0)}"]& \C\xrightarrow{\times a}\C \arrow[u,"{(\times 1, M_3)}"]\arrow[r, "{(\times 0, \times (-1))}"] &\C\arrow[u, "\iota_1"]\\
\end{tikzcd}
)
\]
where 
