...
\begin{itemize}
\item for (\rn{1}), hairs are pointing towards the left i.e. coefficients of $dx$ are negative.
\item for (\rn{2}), hairs are pointing downward i.e. coefficients of $dz$ are negative.
\end{itemize}
\end{itemize}
\end{enumerate}
\end{definition}
